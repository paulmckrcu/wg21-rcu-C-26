...
\vspace{1cm}
\emph{Authors:} \\
Paul McKenney, Michael Wong, Maged M. Michael, Andrew Hunter,
Daisy Hollman, JF Bastien, Hans Boehm, David Goldblatt, Frank Birbacher,
Erik Rigtorp, Tomasz Kamiński, Olivier Giroux, David Vernet, Timur Doumler \\
\vspace{0.5cm}
\emph{email:} \\
paulmckrcu@gmail.com, michael@codeplay.com, maged.michael@acm.org,
andrewhhunter@gmail.com, dhollman@google.com,
...
ogiroux@apple.com, dvernet@meta.com, papers@timur.audio
\end{center}
\vfill
