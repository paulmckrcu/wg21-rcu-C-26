...
\usepackage[pdftex,
            pdftitle={RCU: Proposed Interface and Wording for C++26},
            pdfsubject={RCU: Proposed Interface and Wording for C++26},
...
\include{foreword}
%%\include{general}  @@@ Add code examples differentiating from snapshot?  Or table column?
